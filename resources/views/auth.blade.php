                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <a class="brand-logo" href="javascript:void(0);">
                            <div class="row mx-1 mt-1">
                                ...
                                <h2 class="brand-text text-dark ml-1 mt-50">KOPICHUSEYO</h2>
                            </div>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ asset('/images/pages/kopcus.png') }}" alt="Login V2">
                            </div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h3 class="card-title font-weight-bold text-center mb-1">Welcome to KOPICHUSEYO</h3>
                                <p class="card-text text-center mb-2">Login to your account</p>
                                <form method="POST" action="{{ url('/login') }}" class="user">
                                    ...
                                    <button type="submit" class="btn btn-dark btn-block" tabindex="4">Sign in</button>
                                </form>
                                <p class="text-center mt-2"><span>Don't have an account?</span><a class="text-danger"
