                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-l-2 mx-auto">
                                ...
                                <form method="POST" action="{{ route('register') }}" role="form">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="login-email">Nama</label>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="login-email">Repeat Password</label>
                                        <div class="input-group input-group-merge form-password-toggle">
                                    ...
                                    <button type="submit" class="btn btn-dark btn-block" tabindex="4">Sign up</button>
                                </form>
                                <p class="text-center mt-2"><span>Already have an account?</span>
                                <a class="text-danger" href="/"><span>&nbsp;Login</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
